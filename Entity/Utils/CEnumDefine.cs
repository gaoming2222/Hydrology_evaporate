...
namespace Hydrology.Entity
{
    ...
    public static class CEnumHelper
    {
        ...
        private static readonly string CS_EMessageType_Evp_DBStr = "7";
        ...
        private static readonly string CS_EMessageType_Evp_UIStr = "蒸发报";
        public static string MessageTypeToDBStr(EMessageType type)
        {
            ...
            switch (type)
            {
                ...
                case EMessageType.Evp: { result = CS_EMessageType_Evp_DBStr; } break;
            }
            return result;
        }
        ...
        public static string MessageTypeToUIStr(EMessageType type)
        {
            ...
            switch (type)
            {
                ...
                case EMessageType.Evp: { result = CS_EMessageType_Evp_UIStr; } break;
            }
            return result;
        }
        ...
        public static EMessageType DBStrToMessageType(string type)
        {
            ...
            else if (type.Equals(CS_EMessageType_Evp_DBStr))
            {
                return EMessageType.Evp;
            }
        ...
        public static readonly string CS_EChannelType_Cable_UIStr = "CABLE";
        public static string ChannelTypeToDBStr(EChannelType type)
        {
            switch (type)
            {
                ...
                case EChannelType.Cable: { return CS_EChannelType_Cable_UIStr; }
            }
        ...
        public static EChannelType DBStrToChannelType(string type)
        {
            ...
            }else if (type.Equals(CS_EChannelType_Cable_UIStr))
            {
                return EChannelType.Cable;
            }
        ...
        public static EChannelType UIStrToChannelType(string str)
        {
            ...
            else if (str.Equals(CS_EChannelType_Cable_UIStr))
            {
                return EChannelType.Cable;
            }
