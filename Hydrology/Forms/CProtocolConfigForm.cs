    ...
    public partial class CProtocolConfigForm : Form
    {
        ...
        private void btn_ChannelBrowse_Click(object sender, EventArgs e)
        {
            ...
            if (result == DialogResult.OK && (!m_openFileDialog.FileName.ToString().Equals("")))
            {
                ...
                }else if(this.txt_ChannelDllFileName.Text == "Protocol.Channel.Cable.dll")
                {
        ...
        private void btn_DataBrowse_Click(object sender, EventArgs e)
        {
            ...
            if (result == DialogResult.OK && (!m_openFileDialog.FileName.ToString().Equals("")))
            {
                ...
                else if (this.txt_DataDllFileName.Text == "Protocol.Channel.Reservoir.dll")
                {
                    this.txt_DataProtocolName.Text = "Reservoir";
                }
                else if (this.txt_DataDllFileName.Text == "Protocol.Data.ZFXY.dll")
                {
                    this.txt_DataProtocolName.Text = "ZFXY";
                }
